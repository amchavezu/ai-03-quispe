  ...
  \begin{columns}[T,onlytextwidth]
    \column{0.60\textwidth}
      ...
      \IfFileExists{hand/prop3-endpoint.jpg}{%
        \includegraphics[width=\linewidth,height=0.69\textheight,keepaspectratio]{hand/prop3-endpoint.jpg}%
      }{%
        \begin{tikzpicture}
          \draw[very thick,dashed,Orange,rounded corners=4pt] (0,0) rectangle (8.0,4.5);
          \node[align=center,text=Navy,font=\bfseries\Large] at (4,2.65) {Pending handwritten verification};
          \node[align=center,text=gray!75!black] at (4,1.75) {\texttt{hand/prop3-endpoint.jpg}\\Endpoint $p_2=1$ of Proposition 3};
        \end{tikzpicture}%
      }
